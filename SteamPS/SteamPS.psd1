...
@{
    ...
    # RequiredModules   = @(@{ModuleName = 'PSCache'; GUID = 'c2c9a310-a305-402d-8110-5684124ed41d'; ModuleVersion = '0.1.0'; })
    ...
    FunctionsToExport = @('Install-SteamCMD', 'Update-SteamApp', 'Find-SteamAppID', 'Get-SteamServerInfo')
