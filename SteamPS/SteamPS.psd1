...
@{
    ...
    RootModule        = "$TemplatePowerShellModule.psm1"
    ...
    FunctionsToExport = @('Update-SteamApp')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            LicenseUri = "https://github.com/$Name/$TemplatePowerShellModule/blob/master/LICENSE"
